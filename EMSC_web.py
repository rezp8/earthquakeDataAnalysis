...
start_date.send_keys("01/09/2025")
end_date = driver.find_element(By.ID, "datemax")
end_date.send_keys("30/09/2025")
...
try:
    ...
    while True:
        ...
        for row in data_rows:
            ...
            earthquake_info = {"date": date_, "time": time_, "latitude_deg": latitude_deg, "longitude_deg": longitude_deg,
...
earthquakes_table.to_csv("JAPAN_EMSC.csv", encoding='utf-8-sig')
